...
class CiScriptsBehaviorTest(unittest.TestCase):
    ...
    def test_emit_audit_event_envelope(self) -> None:
        ...
        self.assertEqual(event["schema_version"], "topclaw.audit.v1")
    ...
    def test_deny_policy_guard_passes_with_valid_governance(self) -> None:
        ...
        governance_path.write_text(
            json.dumps(
                {
                    "schema_version": "topclaw.deny-governance.v1",
                    "advisories": [
                        {
    ...
    def test_secrets_governance_guard_passes_for_valid_metadata(self) -> None:
        ...
        governance_path.write_text(
            json.dumps(
                {
                    "schema_version": "topclaw.secrets-governance.v1",
                    "paths": [
                        {
    ...
    def test_generate_provenance_contains_subject_digest(self) -> None:
        ...
        artifact.write_bytes(b"topclaw-provenance-test")
    ...
    def test_unsafe_policy_guard_passes_for_valid_governance(self) -> None:
        ...
        governance_path.write_text(
            json.dumps(
                {
                    "schema_version": "topclaw.unsafe-audit-governance.v1",
                    "ignore_paths": [
                        {
                            "path": "legacy/vendor",
                            "owner": "repo-maintainers",
    ...
    def test_release_manifest_generates_checksums_and_report(self) -> None:
        ...
        (artifacts / "topclaw-x86_64-unknown-linux-gnu.tar.gz").write_bytes(b"release-asset")
        (artifacts / "topclaw.cdx.json").write_text('{"sbom":"ok"}\n', encoding="utf-8")
        ...
        self.assertIn("topclaw-x86_64-unknown-linux-gnu.tar.gz", checksums.read_text(encoding="utf-8"))
    ...
    def test_release_notes_supply_chain_refs_generates_release_preface(self) -> None:
        ...
        (artifacts / "topclaw.cdx.json").write_text('{"sbom":"cdx"}\n', encoding="utf-8")
        (artifacts / "topclaw.spdx.json").write_text('{"sbom":"spdx"}\n', encoding="utf-8")
        (artifacts / "topclaw.sha256sums.intoto.json").write_text('{"_type":"statement"}\n', encoding="utf-8")
        (artifacts / "audit-event-release-sha256sums-provenance.json").write_text(
            '{"schema_version":"topclaw.audit.v1"}\n',
            encoding="utf-8",
        )
        ...
        self.assertIn("/releases/download/v1.2.3/topclaw.cdx.json", sbom_url)
    ...
    def test_ghcr_publish_contract_guard_passes_with_matching_digests(self) -> None:
        ...
        policy.write_text(
            json.dumps(
                {
                    "schema_version": "topclaw.ghcr-tag-policy.v1",
    ...
    def test_ghcr_vulnerability_gate_passes_when_blocking_findings_are_zero(self) -> None:
        ...
        policy.write_text(
            json.dumps(
                {
                    "schema_version": "topclaw.ghcr-vulnerability-policy.v1",
    ...
    def test_docs_deploy_guard_allows_manual_production_rollback_with_preview_evidence(self) -> None:
        ...
        policy.write_text(
            json.dumps(
                {
                    "schema_version": "topclaw.docs-deploy-policy.v1",
        ...
        proc = run_cmd(
            [
                ...
                "https://github.com/topway-ai/topclaw/actions/runs/123",
                "--input-rollback-ref",
                rollback_sha,
                "--policy-file",
                str(policy),
    ...
    def test_release_artifact_guard_detects_missing_archives_in_verify_stage(self) -> None:
        artifacts = self.tmp / "artifacts"
        artifacts.mkdir(parents=True, exist_ok=True)
        (artifacts / "topclaw-x86_64-unknown-linux-gnu.tar.gz").write_bytes(b"linux-gnu")

        contract = self.tmp / "artifact-contract.json"
        contract.write_text(
            json.dumps(
                {
                    "schema_version": "topclaw.release-artifact-contract.v1",
                    "release_archive_patterns": [
                        "topclaw-x86_64-unknown-linux-gnu.tar.gz",
                        "topclaw-x86_64-unknown-linux-musl.tar.gz",
                    ],
                    ...
                    "required_sbom_files": ["topclaw.cdx.json", "topclaw.spdx.json"],
    ...
    def test_release_artifact_guard_passes_for_full_publish_contract(self) -> None:
        ...
        artifacts.mkdir(parents=True, exist_ok=True)
        (artifacts / "topclaw-x86_64-unknown-linux-gnu.tar.gz").write_bytes(b"linux-gnu")
        (artifacts / "topclaw-x86_64-unknown-linux-musl.tar.gz").write_bytes(b"linux-musl")
        (artifacts / "release-manifest.json").write_text('{"ok":true}\n', encoding="utf-8")
        ...
        (artifacts / "topclaw-x86_64-unknown-linux-gnu.tar.gz.sig").write_text("sig\n", encoding="utf-8")
    ...
    def test_release_artifact_guard_rejects_invalid_contract_schema(self) -> None:
        ...
        contract.write_text(
            json.dumps(
                {
                    "schema_version": "topclaw.release-artifact-contract.v0",
                    "release_archive_patterns": ["topclaw-x86_64-unknown-linux-gnu.tar.gz"],
                    "required_manifest_files": ["release-manifest.json"],
                    "required_sbom_files": ["topclaw.cdx.json"],
    ...
    def test_nightly_matrix_report_fails_on_failed_lane(self) -> None:
        ...
        owners.write_text(
            json.dumps(
                {
                    "schema_version": "topclaw.nightly-owner-routing.v1",
                    "owners": {
                        "default": "@ops",
    ...
    def test_canary_guard_promote_when_metrics_within_threshold(self) -> None:
        ...
        policy.write_text(
            json.dumps(
                {
                    "schema_version": "topclaw.canary-policy.v1",
    ...
    def test_prerelease_guard_requires_previous_stage(self) -> None:
        ...
        stage_cfg.write_text(
            json.dumps(
                {
                    "schema_version": "topclaw.prerelease-stage-gates.v1",
    ...
    def test_prerelease_guard_reports_promotion_transition_and_stage_history(self) -> None:
        ...
        self.assertEqual(proc.returncode, 0, msg=proc.stderr)
        report = json.loads(out_json.read_text(encoding="utf-8"))
        self.assertEqual(report["schema_version"], "topclaw.prerelease-guard.v2")
