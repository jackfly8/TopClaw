...
Το TopClaw δρομολογεί συμβάντα MQTT/webhook/cron/περιφερειακών μέσω ενός ενοποιημένου SOP dispatcher (`dispatch_sop_event`).
...
| **Το Cron δεν εκκινεί** | daemon δεν εκτελείται ή μη έγκυρη έκφραση | εκτελέστε `topclaw daemon`· ελέγξτε logs για προειδοποιήσεις ανάλυσης cron |
