...
Το TopClaw υποστηρίζει τα μοντέλα GLM της Z.AI μέσω διεπαφών συμβατών με το OpenAI API.

---

## 1. Τελικά Σημεία και Ψευδώνυμα (Endpoints & Aliases)

Το TopClaw υποστηρίζει τα εξής προκαθορισμένα ψευδώνυμα για την Z.AI:
