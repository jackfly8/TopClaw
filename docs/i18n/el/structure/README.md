# Χάρτης Δομής Τεκμηρίωσης TopClaw
...
- Οι μη αγγλικές τοπικοποιήσεις χρησιμοποιούν canonical paths κάτω από `docs/i18n/<locale>/` και μπορούν να συνδυάζουν bridge pages με επιλεγμένους μεταφρασμένους οδηγούς.
