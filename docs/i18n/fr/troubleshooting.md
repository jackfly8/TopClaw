...
- Si l'auth provider manque ou a expiré, consultez d'abord la nouvelle section “Provider auth missing or expired” de la source anglaise plutôt que la partie webhook pairing.
