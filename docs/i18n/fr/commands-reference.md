...
- Des alias de compatibilité existent encore (`topclaw init`, `chat`, `run`, `info`, `check`, `channels`, `skill`), mais la documentation nouvelle doit privilégier les commandes canoniques.
