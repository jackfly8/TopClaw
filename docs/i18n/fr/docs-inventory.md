# Inventaire documentaire (Français)

Cette page sert d'index rapide des documents top-level dans `docs/i18n/fr/`.

Dernière mise à jour : **24 février 2026**.
État : **parité top-level terminée (40/40)**.

## Sources normatives

- Inventaire anglais : [../../docs-inventory.md](../../docs-inventory.md)
