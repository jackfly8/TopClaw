...
TopClaw provides prebuilt binaries for Android devices.
...
The easiest way to run TopClaw on Android is via [Termux](https://termux.dev/).
...
For advanced users who want to run TopClaw outside Termux:
