...
TopClaw supports Z.AI's GLM models through OpenAI-compatible endpoints.
This guide covers practical setup options that match current TopClaw provider behavior.

## Overview

TopClaw supports these Z.AI aliases and endpoints out of the box:
...
### Test with TopClaw CLI

```bash
# Test agent directly
echo "Hello" | topclaw agent
