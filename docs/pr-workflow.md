# TopClaw PR Workflow (High-Volume Collaboration)

This document defines how TopClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to TopClaw/project-native labels.
...
- Confirm any required identity-like wording uses TopClaw/project-native terminology.
