...
const readingPaths: Array<{
  ...
  {
    id: "newcomer",
    label: { en: "New to TopClaw", zh: "初次了解 TopClaw" },
    detail: {
  ...
  },
  {
    ...
    detail: {
      en: "Connect TopClaw with chat platforms and external providers.",
      zh: "将 TopClaw 接入聊天平台与外部模型能力。",
    },
...
const copy = {
  en: {
    ...
    notice:
      "Official source channels: use this repository as the source of truth and topclawlabs.ai as the official website.",
  ...
  zh: {
    ...
    summary2: "Deploy anywhere. Swap anything.",
    notice:
      "官方信息渠道：请以本仓库为事实来源，以 topclawlabs.ai 为官方网站。",
    ctaDocs: "立即阅读文档",
    ctaBootstrap: "一键安装",
    ...
    startHereTitle: "新手起步",
    startHereLead: "面向首次接触 TopClaw 的核心文档，快速完成有效上手。",
  ...
  return (
    <div className="zc-app">
      ...
      <footer className="footer">
        <p>
          TopClaw · Trait-driven architecture · secure-by-default runtime ·
