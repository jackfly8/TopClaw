# TopClaw Trademark Policy

**Effective date:** February 2026  
**Maintained by:** TopClaw Labs

---

## Our Trademarks

The following are trademarks of TopClaw Labs:

- **TopClaw** (word mark)
- **topclaw-labs** (organization name)
- The TopClaw logo and associated visual identity

These marks identify the official TopClaw project and distinguish it from
...
You **may** use the TopClaw name and marks in the following ways without
prior written permission:

1. **Attribution** — stating that your software is based on or derived from
   TopClaw, provided it is clear your project is not the official TopClaw.

2. **Descriptive reference** — referring to TopClaw in documentation,
...
4. **Fork identification** — identifying your fork as "a fork of TopClaw"
...
You **may not** use the TopClaw name or marks in ways that:

1. **Imply official endorsement** — suggest your project, product, or
   organization is officially affiliated with or endorsed by TopClaw Labs.

2. **Cause brand confusion** — use "TopClaw" as the primary name of a
...
3. **Impersonate the project** — create repositories, domains, packages,
   or accounts that could be mistaken for the official TopClaw project.

4. **Misrepresent origin** — remove or obscure attribution to TopClaw Labs
   while distributing the software or derivatives.

5. **Commercial trademark use** — use the marks in commercial products,
   services, or marketing without prior written permission from TopClaw Labs.
...
you fork TopClaw, you must:

- Clearly state your project is a fork of TopClaw
- Link back to the official repository
- Not use "TopClaw" as the primary name of your fork
...
Contributors to the official TopClaw repository are protected under the
...
TopClaw Labs reserves the right to update this policy at any time. Changes
...
this policy governs use of the TopClaw name and brand.*
