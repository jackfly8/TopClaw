# TopClaw Contributor License Agreement (CLA)
...
property rights granted by contributors to TopClaw Labs. This agreement
protects both contributors and users of the TopClaw project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the TopClaw repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to TopClaw Labs
  for inclusion in the TopClaw project.
...
You grant TopClaw Labs and recipients of software distributed by TopClaw
...
TopClaw that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to TopClaw
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with TopClaw Labs.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the TopClaw name,
...
TopClaw Labs will maintain attribution to contributors in the repository
...
All Contributions accepted into the TopClaw project are licensed under
both:
...
By opening a pull request or submitting a patch to the TopClaw repository,
...
v2.0, adapted for the TopClaw dual-license model.*
